...
/**
 * @author ingmar
 * edited by yusufardi97 for Indonesian Language
 */
class IndonesianPhonemiserTest {

    def phonemiser

    @BeforeSuite
    void setUp() {
        phonemiser = new IndonesianPhonemiser()
    }
    ...
    void testProcess(String lemma, String expectedTranscription, String expectedPos, String expectedMethod) {
        ...
        def input = new MaryData(phonemiser.inputType, new Locale('id'))
